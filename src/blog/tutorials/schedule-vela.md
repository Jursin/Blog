...
- [X] 支持多种预设主题色
- [X] 支持导入[拾光课程表](https://sgschedule.jursin.top/)、[WakeUp课程表](https://www.wakeup.fun/)、[星链课表](https://pd.qq.com/g/pd81186469)和 [CSES](https://cloud.smart-teach.cn/) 的配置文件
...
::: important
**星链课表**需要先选择**课表文件**再在二次弹出的文件选择器中选择**时间表文件**
:::
